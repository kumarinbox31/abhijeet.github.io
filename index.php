...
<head>
    <meta charset="utf-8">
    <title>Portfolio - Abhijeet Kumar Singh</title>
    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <div class="sidebar-footer">
                ...
                <a target="_blank" href="https://www.facebook.com/ak.rajput.7121"><i class="fab fa-facebook-f"></i></a>
                <a target="_blank" href="https://www.linkedin.com/in/abhijeet-kumar-15b316213/"><i
                        class="fab fa-linkedin-in"></i></a>
                <a target="_blank" href="https://www.instagram.com/ak.rajput.7121/"><i class="fab fa-instagram"></i></a>
            </div>
        </div>
        <div class="content">
            <!-- Header Start -->
            <div class="header" id="header">
                <div class="content-inner">
                    ...
                    <h2></h2>
                    <div class="typed-text">Web Designer, Web Developer, PHP Developer, Web Application Developer</div>
                </div>
            </div>
            <!-- Header End -->
                ...
                <div class="content-inner">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 col-lg-7">
                            <p>
                                I am a hardworking Developer. I spend lots of my time in achieving my goals and
                                improving my development skills. I am passionate about my studying and skills.I
                                specialize in PHP Website Designing & Development, E-Commerce Store, and Wordpress
                                CodeIgniter, Finding Bugs and issues and optimization of your site. Here to provide you
                                Quality Services on Time & in Affordable Price. Consultation is always FREE so contact
                                me to know how I can help you.
                            </p>
            ...
            <div class="education" id="education">
                <div class="content-inner">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="edu-col">
                                <span>01-March-2015 <i>to</i> 1-March-2016</span>
                                <h3>10th</h3>
                                <p>Board: Bihar School Examination Board (Patna)</p>
                                <p>School's Name: Vidya Niketan High School Marar, Parsa, Saran (Bihar)</p>
                                <p>Percentage: 61.6%</p>
                        ...
                        <div class="col-md-6">
                            <div class="edu-col">
                                <span>01-March-2016 <i>to</i> 1-March-2019</span>
                                <h3>12th</h3>
                                <p>Board: Bihar School Examination Board (Patna)</p>
                                <p>School's Name: Higher Cum High School, Parsa, Saran (Bihar)</p>
                                <p>Percentage: 62%</p>
                        ...
                        <div class="col-md-6">
                            <div class="edu-col">
                                <span>01-Jan-2019 <i>to</i> 1-Jan-2016</span>
                                <h3>Bachelor of Arts (Pursuing)</h3>

                                <p>Honours Subject: Political Science </p>
                                <p>University: JP University </p>
                                <p>Session: 2019-22</p>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="srv-col">
                                ...
                                <p>I will develop and design PHP website.Are you looking for someone
                                    to build a professional looking eye catchy website for
                                    your
                                    Bussiness,
                                    Factory,
                                    Company,
                        ...
                        <div class="col-md-6">
                            <div class="srv-col">
                                ...
                                <p>I will provide Web Application. Are you looking for someone
                                    to build a Web Application for your website. Then you are at right place. </p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ul id="portfolio-flters">
                                ...
                                <li data-filter=".web-des">Website Development</li>
                                <!-- <li data-filter=".web-dev">Web Application</li>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item web-des">
                            <div class="portfolio-wrap">
                                <figure>
                                    ...
                                    <a href="#" class="link-details" title="More Details"><i class="fa fa-link"></i></a>
                                    <a class="portfolio-title" href="#">Project Name <span>Website Design</span></a>
                                </figure>
                            </div>
                        </div>
                            ...
                            <div class="portfolio-wrap">
                                <figure>
                                    ...
                                    <a href="img/portfolio-3.jpg" class="link-preview" data-lightbox="portfolio"
                                        data-title="Project Name" title="Preview"><i class="fa fa-eye"></i></a>
                                    <a href="#" class="link-details" title="More Details"><i class="fa fa-link"></i></a>
                                    <a class="portfolio-title" href="#">Project Name <span>Website
                                            Development</span></a>
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="contact-info">
                                <p><i class="fa fa-user"></i>Abhijeet singh</p>
                                <p><i class="fa fa-tag"></i>PHP Developer</p>
                                <p><i class="fa fa-envelope"></i><a
                                        href="mailto:kumarinbox31@gmail.com">kumarinbox31@gmailcom</a>
                                </p>
                                <p><i class="fa fa-phone"></i><a href="tel:+91909796829">+91 9097968293</a></p>
                                <p><i class="fa fa-map-marker"></i>Flat no. 404, Lush couny, Ashiyana Road, Patna,
                                    Bihar, 800025</p>
                                <div class="social">
                                    <!-- <a class="btn" href=""><i class="fab fa-twitter"></i></a> -->
                                    <a class="btn" target="_blank" href="https://www.facebook.com/ak.rajput.7121"><i
                                            class="fab fa-facebook-f"></i></a>
                                    <a class="btn" target="_blank"
                                        href="https://www.linkedin.com/in/abhijeet-kumar-15b316213/"><i
                                            class="fab fa-linkedin-in"></i></a>
                                    <a class="btn" target="_blank" href="https://www.instagram.com/ak.rajput.7121/"><i
            ...
            <div class="footer">
                <div class="content-inner">
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <p>&copy; Copyright <a href="#">Abhijeet Kumar </a>. All Rights Reserved
                            </p>
                        </div>
                        <!-- <div class="col-md-6">
